export const MANUAL_LIVE_RAG_SMOKE_CONFIRM_FLAG = '--confirm-manual-live-rag-smoke'

export type ManualLiveSmokeCase = {
  id: 'known-answer' | 'no-answer'
  question: string
  topK: number
}

export type ManualLiveSmokeSummary = {
  eventTypes: string[]
...
export type ManualLiveSmokeEvaluation = {
  ok: boolean
  failedAssertions: string[]
}

export function createManualLiveSmokeCases(): ManualLiveSmokeCase[] {
  return [
    {
      id: 'known-answer',
...
export function createManualLiveSmokeRequestBody(testCase: ManualLiveSmokeCase): { question: string; topK: number } {
  return {
...
export function evaluateManualLiveSmokeCase(
  testCase: Pick<ManualLiveSmokeCase, 'id'>,
  summary: ManualLiveSmokeSummary
): ManualLiveSmokeEvaluation {
...
export function summarizeRagSsePayloads(payloads: unknown[], secretNeedles: string[]): ManualLiveSmokeSummary {
