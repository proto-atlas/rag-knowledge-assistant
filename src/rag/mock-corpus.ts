...
export const mockSearchCorpus: SearchCorpusChunk[] = [
  ...
  },
  {
    ...
    headingPath: ['外部共有'],
    content:
      '顧客資料、設計書、ログ、スクリーンショットを外部へ共有する場合は共有範囲と有効期限を設定します。公開リポジトリへコードを置く前にはsecret scanと公開前チェックを実行します。',
    indexVersion: FIXTURE_INDEX_VERSION
  },
  {
  ...
  },
  {
    ...
    headingPath: ['リリース判定'],
    content:
      'リリース前には、typecheck、lint、unit test、E2E smoke、build、公開前チェックを実行します。失敗した項目がある場合は修正または延期判断を記録します。',
    indexVersion: FIXTURE_INDEX_VERSION
  },
  {
